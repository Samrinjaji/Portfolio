...
function Experience() {
  ...
  return (
    ...
    >
      ...
      {/* Section divider */}
      <div
        className={`mx-auto flex w-full max-w-4xl items-center gap-4 font-mono text-[10px] font-bold uppercase tracking-wider text-ink-deep/40 transition-all duration-700 sm:text-xs ${
          isVisible
      ...
      >
        ...
        <p className="mt-2 max-w-xl text-sm leading-6 text-ink-deep/50 sm:text-base">
        ...
        {experience.map((job, i) => (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <div
                className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-ink-deep/15 bg-ink-deep/3 text-ink-deep/50 transition-all duration-700 ${
                  isVisible
              ...
              {i !== experience.length - 1 && (
                <div
                  className={`mt-1 w-px flex-1 origin-top bg-ink-deep/10 transition-transform duration-1000 ${
